...
def evaluate(model_result_file, use_location_filter=True):
...
for file_path in [
    ...
    'output/MetaFG_meta_0/snake_v0_meta_ovs_e120_arcface/result_snakeclef2022valid.tc',
    'output/MetaFG_meta_0/snake_v0_meta_ovs_e120_seesaw/result_snakeclef2022valid.tc',
    'output/MetaFG_meta_0/snake_v0_meta_ovs_e120_seesaw_im1k/result_snakeclef2022valid.tc',
]:
    output_root_dir = '/mnt/workspace/wuyou.zc/sources/FineGrained/MetaFormer_snake'
    result_file = os.path.join(output_root_dir, file_path)
    # evaluate(model_result_file=result_file, use_location_filter=False)
    evaluate(model_result_file=result_file, use_location_filter=True)
