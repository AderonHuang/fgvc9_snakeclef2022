...
# model_result_file = '/mnt/workspace/wuyou.zc/sources/FineGrained/MetaFormer_snake/output/MetaFG_0/snake_v0/result_snakeclef2022test_v0.tc'
model_result_file = '/path/result_snakeclef2022test_v2.tc'
